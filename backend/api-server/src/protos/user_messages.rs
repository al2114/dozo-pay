...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for GetContactsRequest {}

impl GetContactsRequest {
    pub fn new() -> GetContactsRequest {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static GetContactsRequest {
        static mut instance: ::protobuf::lazy::Lazy<GetContactsRequest> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const GetContactsRequest,
        };
        unsafe {
            instance.get(GetContactsRequest::new)
        }
    }
...
impl ::protobuf::Message for GetContactsRequest {
    fn is_initialized(&self) -> bool {
        true
    }
...
impl ::protobuf::MessageStatic for GetContactsRequest {
    fn new() -> GetContactsRequest {
        GetContactsRequest::new()
    }

    fn descriptor_static(_: ::std::option::Option<GetContactsRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                    "user_id",
                    GetContactsRequest::get_user_id_for_reflect,
                    GetContactsRequest::mut_user_id_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<GetContactsRequest>(
                    "GetContactsRequest",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for GetContactsRequest {
    fn clear(&mut self) {
        self.clear_user_id();
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for GetContactsRequest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for GetContactsRequest {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\x20\x01(\x05R\x06userId\"H\n\x13GetContactsResponse\x121\n\x08conta\
    cts\x18\x01\x20\x03(\x0b2\x15.pesto.models.ContactR\x08contactsJ\xd6\x0f\
    ...
    \x05\x04\x03\x02\0\x04\x12\x04\x17\x02\x16\x17\n\x0c\n\x05\x04\x03\x02\0\
    ...
    \x05\x04\x03\x02\x01\x01\x12\x03\x18\x07\x11\n\x0c\n\x05\x04\x03\x02\x01\
    ...
    \n\x05\x04\x0b\x02\0\x03\x12\x03?%&b\x06proto3\
";
