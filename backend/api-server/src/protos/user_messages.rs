...
impl ::protobuf::Message for LoginRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.device_token.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.device_token);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.device_token.is_empty() {
            os.write_string(3, &self.device_token)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static(_: ::std::option::Option<LoginRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "device_token",
                    LoginRequest::get_device_token_for_reflect,
                    LoginRequest::mut_device_token_for_reflect,
                ));
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for LogoutRequest {}
...
impl LogoutRequest {
    ...
    pub fn default_instance() -> &'static LogoutRequest {
        static mut instance: ::protobuf::lazy::Lazy<LogoutRequest> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const LogoutRequest,
        };
        unsafe {
            instance.get(LogoutRequest::new)
        }
    }
...
impl ::protobuf::MessageStatic for LogoutRequest {
    fn new() -> LogoutRequest {
        LogoutRequest::new()
    }

    fn descriptor_static(_: ::std::option::Option<LogoutRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                    "user_id",
                    LogoutRequest::get_user_id_for_reflect,
                    LogoutRequest::mut_user_id_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "device_token",
                    LogoutRequest::get_device_token_for_reflect,
                    LogoutRequest::mut_device_token_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<LogoutRequest>(
                    "LogoutRequest",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for LogoutRequest {
    fn clear(&mut self) {
        self.clear_user_id();
        self.clear_device_token();
        self.unknown_fields.clear();
...
pub struct ClaimInfoResponse {
    // message fields
    pub claim: ::protobuf::SingularPtrField<super::models::Claim>,
    pub status: super::models::ClaimStatus,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for ClaimInfoResponse {}

impl ClaimInfoResponse {
    pub fn new() -> ClaimInfoResponse {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static ClaimInfoResponse {
        static mut instance: ::protobuf::lazy::Lazy<ClaimInfoResponse> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ClaimInfoResponse,
        };
        unsafe {
            instance.get(ClaimInfoResponse::new)
        }
    }

    // .pesto.models.Claim claim = 1;
    ...
    // .pesto.models.ClaimStatus status = 2;

    pub fn clear_status(&mut self) {
        self.status = super::models::ClaimStatus::UNCLAIMED;
    }

    // Param is passed by value, moved
    pub fn set_status(&mut self, v: super::models::ClaimStatus) {
        self.status = v;
    }

    pub fn get_status(&self) -> super::models::ClaimStatus {
        self.status
    }

    fn get_status_for_reflect(&self) -> &super::models::ClaimStatus {
        &self.status
    }

    fn mut_status_for_reflect(&mut self) -> &mut super::models::ClaimStatus {
        &mut self.status
    }
}

impl ::protobuf::Message for ClaimInfoResponse {
    fn is_initialized(&self) -> bool {
        for v in &self.claim {
            if !v.is_initialized() {
                return false;
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.status != super::models::ClaimStatus::UNCLAIMED {
...
impl ::protobuf::MessageStatic for ClaimInfoResponse {
    fn new() -> ClaimInfoResponse {
        ClaimInfoResponse::new()
    }

    fn descriptor_static(_: ::std::option::Option<ClaimInfoResponse>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::models::Claim>>(
                    "claim",
                    ClaimInfoResponse::get_claim_for_reflect,
                    ClaimInfoResponse::mut_claim_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<super::models::ClaimStatus>>(
                    "status",
                    ClaimInfoResponse::get_status_for_reflect,
                    ClaimInfoResponse::mut_status_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<ClaimInfoResponse>(
                    "ClaimInfoResponse",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for ClaimInfoResponse {
    fn clear(&mut self) {
        self.clear_claim();
        self.clear_status();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for ClaimInfoResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ClaimInfoResponse {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sword\x18\x02\x20\x01(\tR\x08password\x12!\n\x0cdevice_token\x18\x03\x20\
    \x01(\tR\x0bdeviceToken\"W\n\rLoginResponse\x12&\n\x04user\x18\x01\x20\
    \x01(\x0b2\x12.pesto.models.UserR\x04user\x12\x1e\n\nsuccessful\x18\x02\
    \x20\x01(\x08R\nsuccessful\"K\n\rLogoutRequest\x12\x17\n\x07user_id\x18\
    \x01\x20\x01(\x05R\x06userId\x12!\n\x0cdevice_token\x18\x02\x20\x01(\tR\
    \x0bdeviceToken\"8\n\x0cTopupRequest\x12\x10\n\x03uid\x18\x01\x20\x01(\
    \x05R\x03uid\x12\x16\n\x06amount\x18\x02\x20\x01(\x05R\x06amount\"W\n\rT\
    opupResponse\x12&\n\x04user\x18\x01\x20\x01(\x0b2\x12.pesto.models.UserR\
    \x04user\x12\x1e\n\nsuccessful\x18\x02\x20\x01(\x08R\nsuccessful\"b\n\
    \x12TransactionRequest\x12\x19\n\x08payer_id\x18\x01\x20\x01(\x05R\x07pa\
    yerId\x12\x19\n\x08payee_id\x18\x02\x20\x01(\x05R\x07payeeId\x12\x16\n\
    \x06amount\x18\x03\x20\x01(\x05R\x06amount\"\x84\x01\n\x13TransactionRes\
    ponse\x12&\n\x04user\x18\x01\x20\x01(\x0b2\x12.pesto.models.UserR\x04use\
    r\x12%\n\x0etransaction_id\x18\x02\x20\x01(\x05R\rtransactionId\x12\x1e\
    \n\nsuccessful\x18\x03\x20\x01(\x08R\nsuccessful\"W\n\x11AddContactReque\
    st\x12\x17\n\x07user_id\x18\x01\x20\x01(\x05R\x06userId\x12)\n\x10contac\
    t_username\x18\x02\x20\x01(\tR\x0fcontactUsername\"1\n\x0fSuccessRespons\
    e\x12\x1e\n\nsuccessful\x18\x01\x20\x01(\x08R\nsuccessful\"H\n\x13GetCon\
    tactsResponse\x121\n\x08contacts\x18\x01\x20\x03(\x0b2\x15.pesto.models.\
    ContactR\x08contacts\"X\n\x17GetTransactionsResponse\x12=\n\x0ctransacti\
    ons\x18\x01\x20\x03(\x0b2\x19.pesto.models.TransactionR\x0ctransactions\
    \"2\n\x14CheckPasscodeRequest\x12\x1a\n\x08passcode\x18\x01\x20\x01(\tR\
    \x08passcode\"G\n\x12CreateClaimRequest\x12\x16\n\x06amount\x18\x01\x20\
    \x01(\x05R\x06amount\x12\x19\n\x08owner_id\x18\x02\x20\x01(\x05R\x07owne\
    rId\"`\n\x13CreateClaimResponse\x12\x1e\n\nsuccessful\x18\x01\x20\x01(\
    \x08R\nsuccessful\x12)\n\x05claim\x18\x02\x20\x01(\x0b2\x13.pesto.models\
    .ClaimR\x05claim\"=\n\x10GetClaimResponse\x12)\n\x05claim\x18\x02\x20\
    \x01(\x0b2\x13.pesto.models.ClaimR\x05claim\"P\n\x12AcceptClaimRequest\
    \x12\x19\n\x08claim_id\x18\x01\x20\x01(\x05R\x07claimId\x12\x1f\n\x0brec\
    eiver_id\x18\x02\x20\x01(\x05R\nreceiverId\"`\n\x13AcceptClaimResponse\
    \x12\x1e\n\nsuccessful\x18\x01\x20\x01(\x08R\nsuccessful\x12)\n\x05claim\
    \x18\x02\x20\x01(\x0b2\x13.pesto.models.ClaimR\x05claim\"/\n\x12RevokeCl\
    aimRequest\x12\x19\n\x08claim_id\x18\x01\x20\x01(\x05R\x07claimId\"`\n\
    \x13RevokeClaimResponse\x12\x1e\n\nsuccessful\x18\x01\x20\x01(\x08R\nsuc\
    cessful\x12)\n\x05claim\x18\x02\x20\x01(\x0b2\x13.pesto.models.ClaimR\
    \x05claim\"q\n\x11ClaimInfoResponse\x12)\n\x05claim\x18\x01\x20\x01(\x0b\
    2\x13.pesto.models.ClaimR\x05claim\x121\n\x06status\x18\x02\x20\x01(\x0e\
    2\x19.pesto.models.ClaimStatusR\x06status\"\x0c\n\nNoResponseJ\xc8\x1b\n\
    \x06\x12\x04\0\0r\x15\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\
    \x12\x03\x02\x08\x1b\n\t\n\x02\x03\0\x12\x03\x04\x07\x15\n\n\n\x02\x04\0\
    \x12\x04\x06\0\n\x01\n\n\n\x03\x04\0\x01\x12\x03\x06\x08\x17\n\x0b\n\x04\
    \x04\0\x02\0\x12\x03\x07\x02\x16\n\r\n\x05\x04\0\x02\0\x04\x12\x04\x07\
    \x02\x06\x19\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x07\x02\x08\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03\x07\t\x11\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\
    \x07\x14\x15\n\x0b\n\x04\x04\0\x02\x01\x12\x03\x08\x02\x16\n\r\n\x05\x04\
    \0\x02\x01\x04\x12\x04\x08\x02\x07\x16\n\x0c\n\x05\x04\0\x02\x01\x05\x12\
    ...
    \x14\n\x0b\n\x04\x04\x02\x02\0\x12\x03\x12\x02\x16\n\r\n\x05\x04\x02\x02\
    \0\x04\x12\x04\x12\x02\x11\x16\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03\x12\
    \x02\x08\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03\x12\t\x11\n\x0c\n\x05\x04\
    \x02\x02\0\x03\x12\x03\x12\x14\x15\n\x0b\n\x04\x04\x02\x02\x01\x12\x03\
    \x13\x02\x16\n\r\n\x05\x04\x02\x02\x01\x04\x12\x04\x13\x02\x12\x16\n\x0c\
    ...
    \x02\x02\x02\x04\x12\x04\x14\x02\x13\x16\n\x0c\n\x05\x04\x02\x02\x02\x05\
    \x12\x03\x14\x02\x08\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03\x14\t\x15\n\
    \x0c\n\x05\x04\x02\x02\x02\x03\x12\x03\x14\x18\x19\n\n\n\x02\x04\x03\x12\
    \x04\x17\0\x1a\x01\n\n\n\x03\x04\x03\x01\x12\x03\x17\x08\x15\n\x0b\n\x04\
    \x04\x03\x02\0\x12\x03\x18\x02\x17\n\r\n\x05\x04\x03\x02\0\x04\x12\x04\
    \x18\x02\x17\x17\n\x0c\n\x05\x04\x03\x02\0\x06\x12\x03\x18\x02\r\n\x0c\n\
    \x05\x04\x03\x02\0\x01\x12\x03\x18\x0e\x12\n\x0c\n\x05\x04\x03\x02\0\x03\
    \x12\x03\x18\x15\x16\n\x0b\n\x04\x04\x03\x02\x01\x12\x03\x19\x02\x16\n\r\
    \n\x05\x04\x03\x02\x01\x04\x12\x04\x19\x02\x18\x17\n\x0c\n\x05\x04\x03\
    \x02\x01\x05\x12\x03\x19\x02\x06\n\x0c\n\x05\x04\x03\x02\x01\x01\x12\x